...
namespace MediaDedup
{
        ...
        bool ServerInitializer::initializeConfiguration()
        {
            ...
            {
                logger.error("Failed to load configuration: %s", std::string(e.what()));
                return false;
            }
        }
        ...
        bool ServerInitializer::initializeDatabase()
        {
            ...
            {
                logger.error("Failed to initialize database: %s", std::string(e.what()));
                return false;
            }
        }
        ...
        bool ServerInitializer::initializeWebServer()
        {
            ...
            {
                logger.error("Failed to initialize web server: %s", std::string(e.what()));
                return false;
            }
        }
        ...
        bool ServerInitializer::initializeTPM()
        {
            ...
            {
                logger.error("Failed to initialize TPM: %s", std::string(e.what()));
                return false;
            }
        }
        ...
        bool ServerInitializer::initializeSchedulerAndFiles()
        {
            ...
            {
                logger.error("Failed to initialize scheduler and files: %s", std::string(e.what()));
                return false;
            }
        }
