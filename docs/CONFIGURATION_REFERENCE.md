...
| `duplicates.quality.threshold.min`         | double  | 0.0-1.0                                                                                 | `0.94`                       | Applied live (triggers reprocess if decreased)      | Minimum threshold for QUALITY mode - loosest match (0.94-0.96 recommended)   |
| `duplicates.quality.threshold.max`         | double  | 0.0-1.0                                                                                 | `0.98`                       | Applied live                                        | Maximum threshold for QUALITY mode - strictest match (0.96-0.98 recommended) |
| `duplicates.quality.minConfidence`         | double  | 0.0-1.0                                                                                 | `0.90`                       | Applied live                                        | Minimum confidence for semantic match (future feature)                       |
