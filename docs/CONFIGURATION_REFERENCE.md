...
| `duplicates.threshold.min`                 | double  | 0.0-1.0                                                                                 | `0.92`                       | Applied live (triggers reprocess if decreased)      | Minimum similarity threshold for adding files to groups (0.90-0.95 recommended) |
| `duplicates.threshold.max`                 | double  | 0.0-1.0                                                                                 | `0.96`                       | Applied live                                        | Maximum similarity threshold for representative swaps (0.94-0.98 recommended)   |
