...
namespace MediaDedup
{
    ...
    public:
        ...
        const std::string& getModelPath() const { static std::string empty; return empty; }
    };
    ...
    public:
        ...
        void clearCache() {}
        struct PoolStats { bool cache_enabled = false; size_t total_sessions = 0; size_t available_sessions = 0; size_t borrowed_sessions = 0; size_t max_sessions_per_model = 0; };
