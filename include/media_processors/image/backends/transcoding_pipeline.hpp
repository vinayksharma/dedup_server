...
namespace MediaDedup
{
    ...
    public:
         ...
         * @param jpeg_data Output vector to store the transcoded JPEG data
        ...
        /**
         * @brief Transcode a raw image file to JPEG format and save to disk
         *
         ...
         * @param extension The new file extension (e.g., ".jpg")
